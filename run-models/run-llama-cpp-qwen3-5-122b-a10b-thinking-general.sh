...
MODEL="${MODEL:-/run/media/kchauhan/Windows/models/unsloth/Qwen3.5-122B-A10B-GGUF/UD-Q4_K_XL/Qwen3.5-122B-A10B-UD-Q4_K_XL-00001-of-00003.gguf}"
...
cmd=(
  "${LLAMA_SERVER}"
  -m "${MODEL}"
  --alias "unsloth/Qwen3.5-122B-A10B (thinking-general)"
  --seed 3407
  --temp 1.0
  --top-p 0.95
  --top-k 20
