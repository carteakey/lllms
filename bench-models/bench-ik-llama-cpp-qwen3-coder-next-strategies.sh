#!/usr/bin/env bash
# Qwen3-Coder-Next (UD-Q4_K_XL) — ik_llama.cpp MoE strategy experiments
#
...
#                        Costs load time + ~27 GB extra RAM. +0.7 tg, -240 pp.
...
#   fused-muge     fused-moe + merge-up-gate (best tg, worst pp, needs ~73 GB RAM)
