#!/usr/bin/env bash
# Gemma-4-26B-A4B-it (UD-Q5_K_XL) — manual CPU/GPU offload strategy experiments
#
# Strategy overview:
...
#
# Usage:
#   ./bench-llama-cpp-gemma-4-26b-a4b-strategies.sh
#   STRATEGY=late-cpu ./bench-llama-cpp-gemma-4-26b-a4b-strategies.sh
